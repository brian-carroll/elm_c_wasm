...
var Module = typeof createEmscriptenModule !== 'undefined' ? createEmscriptenModule : {};
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'update.wast';
  var wasmBinaryFile = 'update.wasm';
  var asmjsCodeFile = 'update.temp.asm.js';
...
var _update = Module["_update"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_update"].apply(null, arguments) };
