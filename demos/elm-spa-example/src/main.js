...
// Begin Kernel $elm$kernel$Parser$$ deps: $elm$kernel$Utils$$
...
// End Kernel $elm$kernel$Parser$$ deps: $elm$kernel$Utils$$

// Begin Kernel $elm$kernel$Http$$ deps: $elm$kernel$Scheduler$$, $elm$http$Http$BadPayload, $elm$http$Http$BadStatus, $elm$http$Http$BadUrl, $elm$http$Http$Internal$FormDataBody, $elm$core$Maybe$Just, $elm$http$Http$NetworkError, $elm$http$Http$Timeout, $elm$core$Dict$empty, $elm$core$Maybe$isJust, $elm$core$Result$isOk, $elm$http$Http$Internal$isStringBody, $elm$core$Result$map, $elm$core$Dict$update
...
// End Kernel $elm$kernel$Http$$ deps: $elm$kernel$Scheduler$$, $elm$http$Http$BadPayload, $elm$http$Http$BadStatus, $elm$http$Http$BadUrl, $elm$http$Http$Internal$FormDataBody, $elm$core$Maybe$Just, $elm$http$Http$NetworkError, $elm$http$Http$Timeout, $elm$core$Dict$empty, $elm$core$Maybe$isJust, $elm$core$Result$isOk, $elm$http$Http$Internal$isStringBody, $elm$core$Result$map, $elm$core$Dict$update

// Begin Kernel $elm$kernel$Time$$ deps: $elm$kernel$List$$, $elm$kernel$Scheduler$$, $elm$time$Time$Name, $elm$time$Time$Offset, $elm$time$Time$customZone
...
// End Kernel $elm$kernel$Time$$ deps: $elm$kernel$List$$, $elm$kernel$Scheduler$$, $elm$time$Time$Name, $elm$time$Time$Offset, $elm$time$Time$customZone

// Begin Kernel $elm$kernel$Url$$ deps: $elm$core$Maybe$Just, $elm$core$Maybe$Nothing
...
// End Kernel $elm$kernel$Url$$ deps: $elm$core$Maybe$Just, $elm$core$Maybe$Nothing

// Begin Kernel $elm$kernel$Markdown$$ deps: $elm$core$Maybe$isJust
...
// End Kernel $elm$kernel$Markdown$$ deps: $elm$core$Maybe$isJust
// Enum
...
// Define, deps=$elm$core$Basics$False, $elm$core$Basics$True
var $elm$http$Http$Internal$isStringBody = /* Function */function (body) {
	// Case
	// Decider Chain
	if (body.$ === 'StringBody') {
		// Decider Leaf Inline
...
var $elm$core$Result$map = /* Function */F2(
	function (func, ra) {
		// Case
		// Decider Chain
		if (ra.$ === 'Ok') {
			...
			// Destruct
			var a = ra.a;
			return /* Call */$elm$core$Result$Ok(
				/* Call *//* VarLocal */func(/* VarLocal */a));
		} else {
			// Decider Leaf Inline
			// Destruct
			var e = ra.a;
			return /* Call */$elm$core$Result$Err(/* VarLocal */e);
		}
	});
...
// Define, deps=$elm$time$Time$Zone
var $elm$time$Time$customZone = /* VarGlobal */$elm$time$Time$Zone;
...
var wasmWrapper = wrapWasmElmApp(
	EmscriptenModule.buffer,
	EmscriptenModule.asm,
	{
		ctors: ['AddRight', 'Append', 'Apr', 'Article', 'Aug', 'Avatar', 'Bad', 'Black', 'Body', 'ChangedUrl', 'ClickedDeleteArticle', 'ClickedDeleteComment', 'ClickedDismissErrors', 'ClickedFavorite', 'ClickedFeedPage', 'ClickedFollow', 'ClickedLink', 'ClickedPostComment', 'ClickedSave', 'ClickedTab', 'ClickedTag', 'ClickedUnfavorite', 'ClickedUnfollow', 'Comment', 'CommentId', 'CompletedArticleLoad', 'CompletedAuthorLoad', 'CompletedCreate', 'CompletedDeleteArticle', 'CompletedDeleteComment', 'CompletedEdit', 'CompletedFavorite', 'CompletedFavoriteChange', 'CompletedFeedLoad', 'CompletedFollowChange', 'CompletedFormLoad', 'CompletedLoadArticle', 'CompletedLoadComments', 'CompletedLogin', 'CompletedPostComment', 'CompletedRegister', 'CompletedSave', 'CompletedTagsLoad', 'Creating', 'Cred', 'Dec', 'EditArticle', 'Editing', 'EditingNew', 'Editor', 'Email', 'Empty', 'EmptyBody', 'Endpoint', 'EnteredAvatar', 'EnteredBio', 'EnteredBody', 'EnteredCommentText', 'EnteredDescription', 'EnteredEmail', 'EnteredPassword', 'EnteredTags', 'EnteredTitle', 'EnteredUsername', 'Err', 'ExpectingEnd', 'ExpectingSymbol', 'Failed', 'False', 'FavoritedArticles', 'Feb', 'FollowedAuthor', 'Full', 'GlobalFeed', 'Good', 'GotArticleMsg', 'GotEditorMsg', 'GotFeedMsg', 'GotHomeMsg', 'GotLoginMsg', 'GotProfileMsg', 'GotRegisterMsg', 'GotSession', 'GotSettingsMsg', 'GotTimeZone', 'Guest', 'Header', 'Home', 'Image', 'InvalidEntry', 'IsFollowing', 'IsNotFollowing', 'IsViewer', 'Jan', 'Jul', 'Jun', 'Just', 'Loaded', 'Loading', 'LoadingFailed', 'LoadingSlowly', 'LoggedIn', 'Login', 'Logout', 'Mar', 'May', 'MayPreventDefault', 'MayStopPropagation', 'Model', 'MyArticles', 'NewArticle', 'Normal', 'NotFound', 'Nothing', 'Nov', 'Oct', 'Ok', 'Other', 'PaginatedList', 'Parser', 'PassedSlowLoadThreshold', 'Password', 'Perform', 'Posix', 'Preview', 'Problem', 'Profile', 'QueryParameter', 'RBEmpty_elm_builtin', 'RBNode_elm_builtin', 'Red', 'Redirect', 'Register', 'Request', 'Saving', 'Sending', 'Sep', 'ServerError', 'Settings', 'Slug', 'StringBody', 'SubmittedForm', 'Tag', 'TagFeed', 'Title', 'Token', 'Trimmed', 'True', 'UnfollowedAuthor', 'Username', 'Viewer', 'YourFeed', 'Zone'],
		fields: ['article', 'articles', 'author', 'avatar', 'bio', 'body', 'breaks', 'col', 'comments', 'content', 'context', 'contextStack', 'createdAt', 'day', 'defaultHighlighting', 'description', 'email', 'errors', 'expect', 'favorited', 'favoritesCount', 'feed', 'feedPage', 'feedTab', 'form', 'frag', 'githubFlavored', 'headers', 'id', 'indent', 'init', 'isLoading', 'metadata', 'method', 'month', 'offset', 'onUrlChange', 'onUrlRequest', 'page', 'params', 'password', 'problem', 'problems', 'resultsPerPage', 'row', 'sanitize', 'session', 'slug', 'smartypants', 'src', 'status', 'subscriptions', 'tables', 'tags', 'timeZone', 'timeout', 'title', 'total', 'unvisited', 'update', 'url', 'username', 'value', 'values', 'view', 'visited', 'withCredentials', 'year'],
		fieldGroups: ['article$comments$errors$session$timeZone', 'articles$errors$isLoading$session', 'author$body$createdAt$id', 'author$errors$feed$feedPage$feedTab$session$timeZone', 'author$metadata$slug', 'avatar$bio', 'avatar$bio$email$password$username', 'body$description$tags$title', 'body$expect$headers$method$timeout$url$withCredentials', 'body$title', 'breaks$tables', 'col$context$indent$offset$row$src', 'col$contextStack$problem$row', 'col$problem$row', 'content$title', 'createdAt$description$favorited$favoritesCount$tags$title', 'day$month$year', 'defaultHighlighting$githubFlavored$sanitize$smartypants', 'email$password', 'email$password$username', 'feed$feedPage$feedTab$session$tags$timeZone', 'form$problems$session', 'frag$params$unvisited$value$visited', 'init$onUrlChange$onUrlRequest$subscriptions$update$view', 'page$resultsPerPage', 'problems$session$status', 'session$status', 'total$values']
	},
	[_Browser_application, _Browser_load, _Browser_pushUrl, _Browser_replaceUrl, _Browser_setViewport, _Http_expectStringResponse, _Http_toTask, _Json_addEntry, _Json_addField, _Json_andThen, _Json_decodeBool, _Json_decodeField, _Json_decodeInt, _Json_decodeKeyValuePairs, _Json_decodeList, _Json_decodeNull, _Json_decodeString, _Json_decodeValue, _Json_emptyArray, _Json_emptyObject, _Json_encode, _Json_encodeNull, _Json_fail, _Json_map1, _Json_map2, _Json_oneOf, _Json_run, _Json_runOnString, _Json_succeed, _Json_wrap, _List_fromArray, _List_toArray, _Markdown_toHtml, _Parser_isSubChar, _Parser_isSubString, _Platform_batch, _Platform_incomingPort, _Platform_leaf, _Platform_map, _Platform_outgoingPort, _Process_sleep, _Scheduler_andThen, _Scheduler_fail, _Scheduler_onError, _Scheduler_succeed, _String_join, _String_split, _Time_here, _Url_percentDecode, _Url_percentEncode, _VirtualDom_attribute, _VirtualDom_map, _VirtualDom_noJavaScriptOrHtmlUri, _VirtualDom_noJavaScriptUri, _VirtualDom_noOnOrFormAction, _VirtualDom_node, _VirtualDom_on, _VirtualDom_property, _VirtualDom_style, _VirtualDom_text]);
var $author$project$Main$main = wasmWrapper.mains[0];
_Platform_export({'Main':{'init':$author$project$Main$main(/* VarGlobal */$elm$json$Json$Decode$value)(0)}});}
}(this));