module Core.Basics exposing (tests)
    ...
    let
        ...
        basicMathTests =
            describe "Basic Math Tests"
                ...
                , test "logBase 10 100" <| \() -> Expect.within (Relative 0.00000001) 2 (logBase 10 100)
                , test "logBase 2 256" <| \() -> Expect.within (Relative 0.00000001) 8 (logBase 2 256)
