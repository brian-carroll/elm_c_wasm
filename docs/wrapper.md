...
The issue doesn't arise with the "thunks" solution. In that case we only have a _static_ JS array, containing *permanent* references to kernel functions. It never grows and we never need to delete anything!
