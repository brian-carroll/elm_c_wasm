...
char* test_number_binops() {
  ...
  mu_assert("Expect: 1.0 + (-123.456) = -122.456",
            test_float_val(A2(&Basics_add, f1, fm), -122.456));
  ...
  mu_assert("Expect: 1.0 - (-123.456) = 124.456",
            test_float_val(A2(&Basics_sub, f1, fm), 124.456));
  ...
  mu_assert("Expect: 3.14 * (-123.456) = -387.65184",
            test_float_val(A2(&Basics_sub, f1, fm), -387.65184));
